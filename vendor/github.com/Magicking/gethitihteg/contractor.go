...
type BoundContract struct {
	...
	caller     bind.ContractCaller     // Read interface to interact with the blockchain
...
// CreateContract deploys a contract onto the Ethereum blockchain and binds the
...
func CreateContract(opts *bind.TransactOpts, abi abi.ABI, bytecode []byte, backend bind.ContractBackend, params ...interface{}) (common.Address, *types.Transaction, *BoundContract, error) {
	...
	//
	tx, err := c.transactWithoutSigning(opts, nil, append(bytecode, input...))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
...
func (c *BoundContract) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	...
	if opts.Pending {
		pb, ok := c.caller.(bind.PendingContractCaller)
		if !ok {
...
// authorization fields without sending the transaction.
func (c *BoundContract) transactWithoutSigning(opts *bind.TransactOpts, contract *common.Address, input []byte) (*types.Transaction, error) {
	var err error
...
func (c *BoundContract) transact(opts *bind.TransactOpts, contract *common.Address, input []byte) (*types.Transaction, error) {
	var err error
